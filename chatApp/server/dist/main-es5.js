...
var MessageService = /** @class */ (function () {
    function MessageService() {
        ...
        this.socket.on('message recieved', function (data) {
            ...
            _this._chatssub.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this._chats));
        });
        this.socket.on('all messages', function (data) {
            _this._chats = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](data);
            _this._chatssub.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this._chats));
        });
        this.socket.on('user connected', function (data) {
            _this._chats.push({ message: data + " connected", type: 'notify' });
            _this._chatssub.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this._chats));
        });
        this.socket.on('user disconnected', function (data) {
            _this._chats.push({ message: data + " disconnected", type: 'notify' });
            _this._chatssub.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this._chats));
        });
    }
